...
// src/functions/getAccount/handler.ts
__export(exports, {
  main: () => main
});
...
var hello = async (event) => {
  try {
    const data = event.body.ID;
    const url = `https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365207003380/account/${data}?minorversion=1`;
